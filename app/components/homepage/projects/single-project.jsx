  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col items-center justify-between w-full h-full'>
        ...
        <div className="p-6">
          <img src={image ? image?.src : placeholder} alt={name} className="w-80 h-64 transition-opacity duration-[0.7s] delay-[0.3s] rounded-lg group-hover:opacity-0 object-cover" />
        </div>
